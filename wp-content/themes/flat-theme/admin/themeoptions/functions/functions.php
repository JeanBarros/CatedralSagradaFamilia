...
if (!function_exists('of_options'))
{
    ...
    // Header Options
        ...
        $of_options[]   = array(  
            ...
            "desc"      => __("Header background color (default: #431a50).",ZEETEXTDOMAIN),
...
// Styling Options
        ...
        $of_options[]   = array(  
            ...
            "desc"      => __("Default color #431a50, font: Roboto, font-size:14px",ZEETEXTDOMAIN),
            "id"        => "zee_body_text_font",
            "std"       => array('size' => '14px', 'color' =>"#431a50", 'google_fonts'=>array( 'fonts'=>$zee_googlefonts, 'preview_size'=>'16px', 'face' => 'Roboto' ) ), 
            "type"      => "typography",                    
            );
